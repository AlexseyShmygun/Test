...
```
Первый вариант вставки ссылок - это просто написать адрес сайта https://vk.ru
...
## Вставка изображения
```
![Alt-текст](https://img3.fonwall.ru/o/zi/orc-sharp-teeth-beard-close.jpeg?route=mid&amp;h=750 "Орк")
```
